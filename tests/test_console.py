#!/usr/bin/python3
"""All unittests of console.py.
Unittest classing:
    TestCommandeof_prompt
    TestCommandof_helping
    TestCommand_exiting
    TestCommand_creating
    TestCommand_showing
    TestCommand_all
    TestCommand_destroy
    TestCommand_updating
"""
import os
import sys
import unittest
...
class TestCommandeof_prompt(unittest.TestCase):
    """testing prompting command."""
...
class TestCommandof_helping(unittest.TestCase):
...
class TestCommand_exiting(unittest.TestCase):
...
class TestCommand_creating(unittest.TestCase):
...
class TestCommand_showing(unittest.TestCase):
...
class TestCommand_updating(unittest.TestCase):
...
class TestCommand_counting(unittest.TestCase):
    """testing count comand."""

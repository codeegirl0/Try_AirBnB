...
class TestBaseModel_inst(unittest.TestCase):
    ...
    def test_two_mode_unique_ids(self):
        bm1 = BaseModel()
        bm2 = BaseModel()
        self.assertNotEqual(bm1.id, bm2.id)

    def test_two_mode_different_created_at(self):
        bm1 = BaseModel()
        sleep(0.05)
        bm2 = BaseModel()
        self.assertLess(bm1.created_at, bm2.created_at)

    def test_two_mode_different_updated_at(self):
        bm1 = BaseModel()
        sleep(0.05)
        bm2 = BaseModel()
    ...
    def test_instantiation_wth_argg_aand_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
...
class TestBaseModel_to_dicting(unittest.TestCase):
    """testing to_dict."""
